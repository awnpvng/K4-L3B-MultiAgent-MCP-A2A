...
async def _run(root: Path, resume: bool = False) -> None:
    ...
    if resume:
        # keep finished cases; drop trace events of unfinished ones so they are re-run cleanly
...
def parser() -> argparse.ArgumentParser:
    ...
    run.add_argument("--resume", action="store_true", help="skip cases that already have outputs")
